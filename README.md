...
**Highlights**
- Ollama with `llama3.2` and `gemma3`
- Static + Playwright web ingestion
- Structured summaries, facts, topics, reports, and grounded Q&A
- Model comparison and deterministic evaluation
- FastAPI backend
- Gradio interface
...
Local-first document intelligence platform for semantic retrieval, grounded question answering, trusted citations, and measurable RAG evaluation.
...
- RAG evaluation with Hit@K, Recall@K, MRR, citation metrics, and unknown-answer testing
- FastAPI + Gradio
- Observability, security docs, CI, Docker, and client demo package

[View Repository](https://github.com/SincereSag87/docintel-rag)  
[View v1.0.0 Release](https://github.com/SincereSag87/docintel-rag/releases/tag/v1.0.0)

---

### SupportOps Agent

Local-first AI support operations platform with structured tool calling, deterministic policy enforcement, human approval, audit trails, and agent safety evaluation.

**Highlights**
- Structured agent decision loop
- Typed tool schemas and risk levels
- Synthetic customer/order/support backend
- Policy engine using trusted application state
- Human-in-the-loop approvals
- Approval replay protection
- Safe action execution boundary
- Append-only audit trail
- Failure recovery
- 19-case deterministic safety benchmark
- FastAPI backend
- Gradio Operations Console
- Observability, CI, Docker, and client handoff documentation

[View Repository](https://github.com/SincereSag87/supportops-agent)  
[View v1.0.0 Release](https://github.com/SincereSag87/supportops-agent/releases/tag/v1.0.0)
...
I am especially interested in building AI systems that move beyond basic chat interfaces:
...
I am continuing to build production-oriented AI Engineering projects while pursuing opportunities such as:
...
Explore my repositories to see architecture, tests, evaluation results, documentation, and released client-demo projects.
